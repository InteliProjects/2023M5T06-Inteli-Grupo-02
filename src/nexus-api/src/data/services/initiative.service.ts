...
export class InitiativeService implements IInitiativeService {
  ...
  public async updateInitiative(id: string, updateDto: InitiativeDto): Promise<InitiativeEntity> {
    const updatedInitiative = await this.repository.updateInitiative(id, updateDto);
