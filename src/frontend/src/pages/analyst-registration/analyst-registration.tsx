...
const AnalystRegistration: React.FC = () => {
  ...
  return (
    <div className="relative h-screen flex flex-col items-center drop-shadow-[0_4px_4px_rgba(0,0,0,10%)] justify-center overflow-hidden">
    <div className="bg-white drop-shadow-[0_4px_4px_rgba(0,0,0,10%)] rounded p-6 w-[50%]">
      <div className="p-8 rounded bg-white">
        ...
        <p className="text-gray-600 mt-6 text-xl">
          Cadastre-se aqui como um analista de iniciativas para conseguir avaliar e/ou acompanhar o andamento das iniciativas
        </p>
